        ...
        <div class="col-md-9">
            <div class="panel panel-default">            
            	<div class="panel-heading" style="background-color:#337AB7; color:white;" >
            		<h2 style="margin-top:0px; margin-bottom:0px;">Đọc sách</h2>
            	</div>
				    ...
				    <div class="row-item row">
	                	...
	                	<div class="col-md-8 border-right">
		                    ...
		                    <div class="col-md-7">
		                        <h3>{{$tin1['TieuDe']}}</h3>
		                        <p>{{$tin1['TomTat']}}</p>
		                        <a class="btn btn-primary" href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">Đọc<span class="glyphicon glyphicon-chevron-right"></span></a>
							</div>
